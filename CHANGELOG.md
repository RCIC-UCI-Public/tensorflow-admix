...
## [Unreleased](https://github.com/RCIC-UCI-Public/tensorflow-admix/compare/2.5...HEAD)

### Commits

- udpate copyright [`00f1e7b`](https://github.com/RCIC-UCI-Public/tensorflow-admix/commit/00f1e7be69b332475ee8efab6cfb8ff74240014f)
- use actual rpm size [`7ec743f`](https://github.com/RCIC-UCI-Public/tensorflow-admix/commit/7ec743fb3df8a92348f43d34fdfe62029444da54)
- update rpmdb for rocky 9.7 [`0b12562`](https://github.com/RCIC-UCI-Public/tensorflow-admix/commit/0b125620a5c48996f5876a7409f040a0f3523d18)
- add admix expected rpms sizes [`354da29`](https://github.com/RCIC-UCI-Public/tensorflow-admix/commit/354da29a5b78f2a3ba6041d284784955474a640f)
- ignore build stage directories [`ec128b9`](https://github.com/RCIC-UCI-Public/tensorflow-admix/commit/ec128b98ade7b9b6e83a5802fc5b06f06a1eb96e)
- The first statement of the description shdold [`cefd077`](https://github.com/RCIC-UCI-Public/tensorflow-admix/commit/cefd0772144c5b647a60fda8b84f04067e6af3b9)
- The older version of bazel is not compatible with gcc 11. It needs to [`5c19358`](https://github.com/RCIC-UCI-Public/tensorflow-admix/commit/5c19358545d207a7525b1beacb68b2706cfc7cf3)
- tensorflow 2.0.0 no longer compatible with Rocky9 because is requires [`8ab2c2c`](https://github.com/RCIC-UCI-Public/tensorflow-admix/commit/8ab2c2c19a63518f3323a804f8462415ff581796)
- add admix name [`4925857`](https://github.com/RCIC-UCI-Public/tensorflow-admix/commit/4925857989d8ce7e17ee1e28dbfec52ce14ab4c1)
- bootstrap and build targets shoudl be empty if using builds only in sets [`864cffc`](https://github.com/RCIC-UCI-Public/tensorflow-admix/commit/864cffcd172385668fa685ead993599d0943ea1b)
- separate tensorflow 2.0.0 into its own set. No builds from packages.yaml [`532c645`](https://github.com/RCIC-UCI-Public/tensorflow-admix/commit/532c645e26fe00cb47bdfdc7227147c86f216c45)

## [2.5](https://github.com/RCIC-UCI-Public/tensorflow-admix/compare/2.0...2.5) - 2025-01-21

### Commits

- run auto-changelog before tagging [`c35cd7e`](https://github.com/RCIC-UCI-Public/tensorflow-admix/commit/c35cd7eacaa8840db2e2e5ae8848a7ee64379153)
- use separate module release for each tensorflow install. [`716b827`](https://github.com/RCIC-UCI-Public/tensorflow-admix/commit/716b82737dd3a87b8de6d586661f8675c527446d)
- update CHANGELOG [`2dd6fdf`](https://github.com/RCIC-UCI-Public/tensorflow-admix/commit/2dd6fdfb8cd0d73195f6fe3b839af0cb761de1de)
- keras version 3* needs additional dependencies [`a74e397`](https://github.com/RCIC-UCI-Public/tensorflow-admix/commit/a74e397e58f02f7bedff07bed245253dce20ff6e)
- add tensorflow 2.16.1 and its prerequisites [`f3a7ac1`](https://github.com/RCIC-UCI-Public/tensorflow-admix/commit/f3a7ac1b0ba8a3289d7f83474bf36c9ea09f8ab3)
- add dependency on TensorRT so it is loaded automatically [`d2db5e8`](https://github.com/RCIC-UCI-Public/tensorflow-admix/commit/d2db5e89f1c777bffdb226b9565191b91350c128)
- use whl file to build the package. [`86dfb3d`](https://github.com/RCIC-UCI-Public/tensorflow-admix/commit/86dfb3d5b8c02b80dc278982c079e1f7729e4c0e)
- add notes for TensorRT with cuda 12 [`0c054f8`](https://github.com/RCIC-UCI-Public/tensorflow-admix/commit/0c054f8503a7b44d66c28dcb4c62f9e00bbfb7b3)
- provide for tf versions different requirements [`652ad0b`](https://github.com/RCIC-UCI-Public/tensorflow-admix/commit/652ad0b2925c9e6ece56f4cf35a430a04e3e404a)
- enable different build type for different versions. [`5422932`](https://github.com/RCIC-UCI-Public/tensorflow-admix/commit/542293244ec2998369d3907a85842f0d2cd9db82)
- prevent build-id links from being added to RPM [`8255ddc`](https://github.com/RCIC-UCI-Public/tensorflow-admix/commit/8255ddce2e723f95e23697339427c16a88cd6ff2)
- rm old file [`1bd22ac`](https://github.com/RCIC-UCI-Public/tensorflow-admix/commit/1bd22ac46d00b37eaa5ae3c21dfd3adf2cdf0416)
- newer flatbuffers vdistros use license_files variable [`1d5e73c`](https://github.com/RCIC-UCI-Public/tensorflow-admix/commit/1d5e73c2bb5aad4d4d180b3c598253aa219752c4)
- newer bazel requires java [`682f99f`](https://github.com/RCIC-UCI-Public/tensorflow-admix/commit/682f99f23c498fc6d8b2b3a7fce96898d84a3ddb)
- typo [`8b795a9`](https://github.com/RCIC-UCI-Public/tensorflow-admix/commit/8b795a9018bd492fc450a0731b9ab0861ec62cdb)
- add auto-changelog generated CHANGELOG.md [`5708e01`](https://github.com/RCIC-UCI-Public/tensorflow-admix/commit/5708e014a71f0c9ab2867ed004989fa0752ceef3)
